...
/* package pfp-0.1.0.0 */
#ifndef VERSION_pfp
#define VERSION_pfp "0.1.0.0"
#endif /* VERSION_pfp */
#ifndef MIN_VERSION_pfp
#define MIN_VERSION_pfp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pfp */
...
#define CURRENT_COMPONENT_ID "pfp-0.1.0.0-inplace-pfp"
